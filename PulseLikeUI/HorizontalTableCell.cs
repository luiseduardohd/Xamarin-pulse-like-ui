...
{
	public partial class HorizontalTableCell : UITableViewCell
	{
		//public UITableView horizontalTableView { get; set; }

		public HorizontalTableCell() : base()
		{
			inizialize();
		}

		public HorizontalTableCell (UITableViewCellStyle style, string cellIdentifier):base(style,cellIdentifier)
		{
			//throw new NotImplementedException ();
			inizialize();
		}
		public HorizontalTableCell(IntPtr handle) : base(handle)
		{
			inizialize();
		}
